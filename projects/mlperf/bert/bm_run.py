...
def get_args():
    ...
    parser.add_argument("--backend", choices=["bm", "tf", "pytorch", "onnxruntime", "tf_estimator"], default="bm", help="Backend")
    ...
    parser.add_argument("--performance_count", type=int, default=20, help=" performance_count")
...
def main():
    ...
    if args.accuracy:
        cmd = "python3 {:}/accuracy-squad.py {}".format(os.path.dirname(os.path.abspath(__file__)),
                                                        '--max_examples={}'.format(
